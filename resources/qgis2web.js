...
map.getView().fit([1183345.766354, 316423.626312, 1235537.815455, 349117.109486], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">ZONE URBAINE EBOLOWA</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (69 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Cette carte présente les hotels, marchés, pharmacies écoles d\'Ebolowa';
            }
